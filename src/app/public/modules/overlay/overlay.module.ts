...
import { SkyCoreAdapterModule } from '../adapter-service/adapter.module';
...
@NgModule({
  imports: [CommonModule, RouterModule, SkyCoreAdapterModule],
  declarations: [SkyOverlayComponent],
  entryComponents: [SkyOverlayComponent],
  providers: [SkyAppWindowRef, SkyOverlayAdapterService, SkyOverlayService]
})
