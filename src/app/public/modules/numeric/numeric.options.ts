...
export class NumericOptions {
  ...
  /**
   * Specifies the ISO4217 currency code to use for currency formatting. If you do not specify a currency code, the component uses the browser's culture to determine the currency unless your SPA provides a different culture with `SkyAppLocaleProvider`.
   */
  public iso = 'USD';
  ...
  /**
   * Indicates whether to shorten numbers to rounded numbers and abbreviation characters such as K for thousands, M for millions, B for billions, and T for trillion.
   */
