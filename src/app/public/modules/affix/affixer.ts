...
export class SkyAffixer {
  ...
  public destroy(): void {
    ...
    this._offsetChange = this._placementChange = this._overflowScroll = undefined;
  }
  ...
  private reset(): void {
    ...
    this._config = this.affixedRect = this.baseElement = this.baseRect = this.currentPlacement = this.currentOffset = this.overflowParents = undefined;
  }
