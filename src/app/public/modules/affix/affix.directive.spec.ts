...
describe('Affix directive', () => {
  ...
  it('should allow adjustments to overflow parent offset', () => {
    ...
    const affixedElementWidth = componentInstance.affixedRef.nativeElement.getBoundingClientRect()
      .width;
  ...
  it('should find correct placements when the base element is larger than the affixed element', () => {
    ...
    const originalBaseElementWidth = componentInstance.baseRef.nativeElement.getBoundingClientRect()
      .width;
    ...
    const baseElementWidth = componentInstance.baseRef.nativeElement.getBoundingClientRect()
      .width;
  ...
  it('should emit a placement of `null` if base element hidden', () => {
    ...
    const baseElementHeight = componentInstance.baseRef.nativeElement.getBoundingClientRect()
      .height;
